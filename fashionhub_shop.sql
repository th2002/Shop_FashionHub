...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 04, 2023 lúc 07:42 PM
...
(1, 'Quần áo', 0, NULL, NULL),
(2, 'Giày dép', 0, NULL, NULL),
...
(1, '27372771213', 0, 100000, 1, '2023-08-19', '2023-08-04', '2023-08-04');
...
(1, 3, 'wdqwe', '242423124', 'ewqd', 'qwew', 'qewqd', 'qwed', 1, 0, 100000, 0, 0, '2023-08-03'),
(2, 4, 'Nam Nam', '2435635252', 'sfcs', 'wrewr', 'HCM', 'weqwd', 1, 0, 2000000, 0, 0, '2023-08-03'),
(3, 3, 'Khach', '5469034424', 'dfgchb', 'ythtgrf', 'jhgf', 'yhfgdsd', 1, 0, 50000, 0, 0, '2023-08-05');
...
INSERT INTO `oder_detail` (`id`, `product_id`, `quantity`, `oder_id`) VALUES
(1, 16, 20000, 3),
(2, 11, 20000, 2),
(4, 4, 50000, 2),
(5, 9, 20000, 3);
...
(21, 'Quần ngắn không dây', 'Cá tính', 100, 500000, 60000, 1, 1, NULL, '2023-08-04', '2023-08-04', -1);
...
(9, 'trunghieu1234', 'hieudltps18810@fpt.edu.vn', '$2y$10$JYSLl4WUB/e8KOH8iiSbcuCW19vLFREo0kSELcCi.XI4STrOknCv2', 'Hiếu Trung', 937028400, NULL, 1, 1, '::1'),
...
(12, 'khach2', 'hahahihi@gmail.com', '$2y$10$SvT6vBP0ch9MtSPLNxqzPeyGdog5.lW8FfKcP4iVRBdBPKwi5EcYe', 'Tiên', 906757332, NULL, 0, 0, '::1'),
(13, 'lancave', 'lan@gmail.com', '$2y$10$4CdUvmrYVRS2bQYVjzLO6eIorc/7mY8ywK05zLRZJCMmjc0Wt7K4u', 'namnam', 25645645, NULL, 1, 0, '::1');
