...
>>>>>>> 8ad582b454993a1f0dbe4018ad40ecb2dd5cc2ce
                    </div>
                </div>
            </div>
    </div>
...
=======
                                        ...
                                        <a style="pointer-events: none;" id="idPay"><button id="paymentButton" style="padding: 0 5px;opacity: .1;cursor: default;">Mua
                                                Hàng</button></a>
                                    <?php else : ?>
                                        <a style="margin-left: 20px; text-decoration:none; font-weight:bold; color:#f9f9f9; background-color:#fb5533;height: 25px; display: flex;align-items:center; justify-content: center; ;width:90px;" class="btn_login" href="<?php echo $SITE_URL; ?>/tai-khoan/login.php">Đăng
                                            nhập</a>
                                    <?php endif; ?>
                                </div>
>>>>>>> 8ad582b454993a1f0dbe4018ad40ecb2dd5cc2ce
