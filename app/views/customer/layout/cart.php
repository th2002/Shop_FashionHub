...
<<<<<<< HEAD
                    <img src="../../../../assets/images/logos/FhashionHub2-removebg-preview.png" alt="" class="header_logo-item">
=======
                    <img src="<?= $ASSET_URL ?>/images/logos/FhashionHub2-removebg-preview.png" alt="" class="header_logo-item">
>>>>>>> sub_main2
                                ...
                                <td>
                                    <div class="product">
                                        <div class="product-box">
                                            <img src="https://product.hstatic.net/1000284478/product/<?= $item['imgName'] ?>" alt="" class="product_img">
                                        </div>
...
<<<<<<< HEAD
                                ...
                                <td>
                                    <div class="product_delete">
                                        <a href="../../../models/DAO/delete_cart_page.php?id_product=<?=$item['id_price']?>" class="product_delete-link">Xóa</a>
                                    </div>
                                </td>
                            </tr>
                        <?php
=======
                                    ...
                                    <td>
                                        <div class="cart-item">
                                            <div class="quantity">
                                                <button class="quantity-btn decrease">-</button>
                                                <input type="number" id="total_quantity" class="quantity-input" value="<?= $item['quantity'] ?>" min="1">
                                                <button class="quantity-btn increase">+</button>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="product_delete">
                                            <a href="<?= $DAO_URL ?>/delete_cart_page.php?id_product=<?= $item['id_price'] ?>" class="product_delete-link">Xóa</a>
                                        </div>
                                    </td>
                                </tr>
                        <?php
...
=======
                            ...
                            ?>
                                <!--  -->
                                <a style="pointer-events: none;" id="idPay"><button id="paymentButton" style="padding: 0 5px;opacity: .1;cursor: default;">Mua
                                        Hàng</button></a>
                            <?php else : ?>
                                <a style="margin-left: 20px; text-decoration:none; font-weight:bold; color:#f9f9f9; background-color:#fb5533;height: 25px; display: flex;align-items:center; justify-content: center; ;width:90px;" class="btn_login" href="<?php echo $SITE_URL; ?>/tai-khoan/login.php">Đăng nhập</a>
                            <?php endif; ?>
>>>>>>> sub_main2
                        </div>
                    </div>
        ...
        if(inputCheckBox.checked){
            ...
            if(allCheckInput.length >1){
                ...
                allCheckInput.forEach(function(input){
                  ...
                  total += priceToInt(input.parentElement.parentElement.querySelector('.cart-item__total').innerText);
               })
            }else{
        ...
        btnPay.addEventListener('click', function(e) {
            ...
            listCheck.forEach(function(check) {
                if (check.checked) {
                    ...
                    var quantity = check.parentElement.parentElement.querySelector('td .cart-item .quantity input.quantity-input').value;
                    obj[productId] = {
                        quantity: quantity,
                        order:"order"
                    };
