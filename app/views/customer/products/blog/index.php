    ...
    <div id="wrapper">
        ...
        <nav>
            ...
            <div class="nav__center">
                <div class="nav_logo">
                    <img src="<?= $ASSET_URL ?>/images/logos/FashionHub-removebg-preview.png" alt=""
                        class="nav_logo-img">
                </div>
            </div>
            <div class="nav__right">
              ...
              ?>
                        ...
                        <a class="nav_cart-btn" style="text-decoration: none; color: #333;"
                            href="<?=$SITE_URL ?>/layout/cart.php">Xem Giỏ
                            Hàng</a>
                    </div>
                </div>
      ...
      ?>
            <div class="row mb-2">
                <div class="col-md-6">
                    <div
                        class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative header-left-img-main ">
                ...
                <div class="col-md-6">
                    <div
                        ...
                        <div class="col p-4 d-flex flex-column position-static">
                            <strong
                                class="pro-name d-inline-block mb-2 text-success-emphasis"><?php echo $row['name']; ?></strong>
                      ...
                      ?>
                            ...
                            <div class="pro-so_luong">
                                ...
                                <div class="pro-so_luong-main">
                                    ...
                                    <div>
                                        <p><span class="quantity-detail"><?php echo $row['quantity'] ?></span> sẩn phẩm
                                            có sẵn </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pro-end">
                                <button style="cursor: pointer;" data-id="<?= $id ?>" type="button"
                                    class="btn-tined">Thêm Vào Giỏ Hàng</button>
                                ...
                                <div class="col l-3" style="max-width: 96%;">
                                    <div class="product_item">
                                        <div class="product_img">
                                            <a href="index.php?id=<?= $value['product_id'] ?>"><img
                                                    src="<?php echo $value['image_url'] ?>" alt=""
                                                    class="product_img-item"></a>
                ...
                <div class="col-md-4">
                    <div class="position-sticky" style="top: 2rem;">
                        <div class="p-4 mb-3 bg-body-tertiary rounded">
                            ...
                            <p class="mb-0">Chào mừng bạn đến với FASHIONHUB.Với những sản phẩm tuyệt vời và phù hợp với
                                mọi lứa tuổi , tự tin khoe phong cách của bạn</p>
                        </div>
                ...
                ?>
                                <li>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <small
                                            class="text-body-secondary"><?php echo number_format($value['price']) . " " . "₫"; ?></small>
                                    </div>
                                </li>
                                <?php }
                } ?>
        ...
        if (isvalid != false) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    document.querySelector('.nav__cart-quantity span').innerHTML = response[
                        1];
                },
